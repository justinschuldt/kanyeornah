System.register(['angular2/core', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            FinishedComponent = (function () {
                function FinishedComponent(_routeParams) {
                    this._routeParams = _routeParams;
                }
                FinishedComponent.prototype.ngOnInit = function () {
                    this.correctCount = +this._routeParams.get('correctCount');
                };
                FinishedComponent.prototype.goBack = function () {
                    window.history.back();
                };
            ...
            exports_1("FinishedComponent", FinishedComponent);
        }
    }
});
